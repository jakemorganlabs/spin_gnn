...
| C2 | message is SO(3)-equivariant | Prop 2 | spin_gnn/tests/test_message.py | pending |
| C3 | full model is SO(3)-equivariant on interior U | Prop 3 | spin_gnn/tests/test_invariance.py, test_equivariance.py, diagnostics | pending |
| C4 | full model is exactly O-equivariant everywhere | Prop 4 | spin_gnn/tests/test_equivariance.py::test_octahedral_exact | pending |
| C5 | full model is NOT generically equivariant at walls | Prop 4 | spin_gnn/tests/test_equivariance.py::test_generic_rotation_breaks | pending |
| C6 | phi is a scalar, not a geometric spin, in v0 | Prop 5 | docs only | pending |
| C7 | phase update is the exact constant-speed flow | Prop 7 | spin_gnn/tests/test_phase_wrap.py::test_closed_form | pending |
| C8 | scalar path separates a distance-degenerate pair | Prop 8 | spin_gnn/tests/test_expressivity.py | pending |
